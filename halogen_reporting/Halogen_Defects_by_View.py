...
datafromjson = jira.search_issues('project ="Halogen User Testing"  AND issuetype = "View"', maxResults=1000)
...
defects.to_excel("O:/defects.xlsx", index=False)
views.to_excel("O:/views.xlsx", index=False)
...
newdata.to_excel("O:/Halogendata.xlsx", index=False)
