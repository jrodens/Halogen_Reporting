...
datafromjson = jira.search_issues('project = NYC-IO-Surge-Testing and "Application(s) Impacted" is not EMPTY and status != Rejected',maxResults=1000)
...
for issue in datafromjson:
    ...
    created = datetime.datetime.strptime(issue.fields.created[0:10], '%Y-%m-%d')
...
newdata.insert(9, "Labels", Labels)
newdata.insert(10,"Created On", Created)
...
with pd.ExcelWriter(filename) as writer:
    ...
    worksheet4.set_column('K:K',16.29,formater)
    worksheet5.set_column('K:K',16.29,formater)
    worksheet6.set_column('K:K',16.29,formater)
    worksheet7.set_column('K:K',16.29,formater)
    ...
    worksheet4.autofilter('A1:K1000')
    worksheet5.autofilter('A1:K1000')
    worksheet6.autofilter('A1:K1000')
    worksheet7.autofilter('A1:K1000')
