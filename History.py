...
datafromjson = jira.search_issues('project = NYC-IO-Surge-Testing AND "Service (NYCTT)" is not EMPTY and (status = "Needs More Information" or status = "QA")', maxResults=1000)
