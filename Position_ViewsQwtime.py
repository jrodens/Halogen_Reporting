...
datafromjson = jira.search_issues('project = NYC-RIO-Surge-Halogen-Analysis and "Epic Link" = NYCRSA-993', fields= 'summary, status, key, labels, issuelinks',maxResults=1000)
        ...
        if hasattr(link, "outwardIssue"):
            ...
            if "NYCRS" in inwardIssue.key and inwardIssue.key[5] != 'A':
                ...
                if "Accepted" in s:
                    ...
                    openitem= openitem +1
    timetoload = time.perfcounter()
    print(f'View assessed in {round(timetoload-starttimetoload,2)} seconds')
    Report.append(summ)
